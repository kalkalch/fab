...
from ..db.models import AccessRequest, UserSession, AccessStatus, SOURCE_TELEGRAM
...
class AccessManager:
    ...
    def create_session(
        ...
        return db_manager.create_session(
            source, telegram_user_id, chat_id, expiry_seconds
        )
    ...
    def create_access_request(
        ...
        return db_manager.create_access_request(
    ...
    def get_active_requests_for_user(
        self, telegram_user_id: int, source: str = SOURCE_TELEGRAM
    ) -> List[AccessRequest]:
        """Get all active access requests for a user."""
        return db_manager.get_active_requests_for_user(source, telegram_user_id)
